  ...
  return (
    <div className="App">
      ...
      <button onClick = {onClickHandlerIphone}>
        <img src="https://store.storeimages.cdn-apple.com/4668/as-images.apple.com/is/iphone-12-pro-family-hero?wid=470&hei=556&fmt=jpeg&qlt=95&.v=1604021663000"
        style={{height:"200px",cursor:"pointer"}}></img>
      </button>
      ...
      <div>
        ...
        <p>here are my top picks for {ecosystem} devices</p>

        <ul>
          <li>{phone1} ,rating = {rating1}</li>
          <li>{phone2} ,rating = {rating2}</li>
          <li>{phone3} ,rating = {rating3}</li>
        </ul>
      </div>
    </div>
  );
